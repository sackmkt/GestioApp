...
const buildSystemInstruction = ({ user, snapshot }) => {
  ...
  return [
    ...
    'No brindes consejos legales, médicos ni recomendaciones que puedan implicar responsabilidades legales. Sugiere consultar con un profesional habilitado o con la autoridad competente cuando surjan esas dudas.',
